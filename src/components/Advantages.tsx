...
const advantages = [
  ...
  },
  {
    ...
    description: "Помогаем упаковать опыт, подготовить резюме и правильно презентовать себя премиальным семьям.",
  },
  {
    icon: CalendarClock,
  ...
  {
    icon: Banknote,
    title: "Рост дохода выпускников",
    description: "Выпускницы осознанно выходят на более высокие гонорары за счёт компетенций, а не только за счёт часов.",
  },
];
