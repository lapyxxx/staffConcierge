...
const audiences = [
  {
    num: "01",
    text: "Тем, у кого уже есть опыт общения с детьми, но хочется систематизировать свои знания, лучше понимать возрастные особенности и выстраивать доверительные отношения с семьёй.",
  },
  {
    num: "02",
    text: "Тем, кто делает первые шаги в познании детской психологии и педагогики и хочет получить целостное представление о развитии, уходе и безопасной организации пространства для детей.",
  },
  {
    num: "03",
    text: "Тем, кто знаком с развивающими занятиями и образовательными подходами, но хочет глубже изучить вопросы бытового ухода, режима и взаимодействия с родителями.",
  },
];
