...
const FinalCTA = () => {
  ...
  const scrollToForm = () => openApplication("consultation");
        ...
        <div className="max-w-2xl">
          ...
          >
            <h2 className="heading-xl text-cream mb-6">
              Сделайте следующий шаг в профессии няни
            </h2>
            <p className="text-cream/60 text-base mb-10">
              Оставьте заявку — специалист Академии расскажет о программе, поможет выбрать формат
              обучения и ответит на вопросы. Консультация не обязывает к покупке.
            </p>
          </motion.div>
