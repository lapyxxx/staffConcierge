...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { question: "Будет ли поддержка после курса?", answer: "Да, все выпускники получают доступ к закрытому сообществу. В зависимости от тарифа — дополнительные консультации и сопровождение до 6 месяцев." },
