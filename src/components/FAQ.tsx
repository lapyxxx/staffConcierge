...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { question: "Какой сертификат я получу?", answer: "По итогам обучения вы получаете сертификат установленного образца. Информация о лицензировании предоставляется по запросу." },
