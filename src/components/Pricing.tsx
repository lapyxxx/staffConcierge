...
// Блок «Точечные модули» временно скрыт по просьбе заказчика.
// Чтобы вернуть — поставить true.
const SHOW_POINT_MODULES = false;
...
const plans = [
  {
    ...
    features: [
      "13 модулей подготовки: от возрастной психологии, развития ребёнка и первой помощи до этикета, взаимодействия с семьёй и юридической защиты специалиста",
