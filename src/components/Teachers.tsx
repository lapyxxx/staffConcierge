...
const teachers: Teacher[] = [
  ...
  },
  {
    ...
    role: "Имидж-консультант",
    specialization: "Имидж и этикет, репутация и манеры",
    qualification: ["Персональный стилист и имидж-консультант"],
    about: [
    ...
    experience: [
      "Персональный стилист и имидж-консультант",
      "Более 10 лет заботы о гардеробах",
      "Среди клиентов эксперты и предприниматели с Рублёвки и Новой Риги",
  ...
  {
    image: expertIpatova,
    name: "Ипатова Ольга Валерьевна",
    role: "Няня",
    specialization: "Уход и развитие, домашние занятия, организация режима дня",
    qualification: ["Практикующая няня, специалист по работе в семьях премиум-сегмента"],
    about: [
      "5 лет практической работы няней в семьях — с детьми от 1,5 до 9 лет, в форматах проживания в семье, вахты и частичной занятости, включая VIP-семьи Москвы",
      "Более 20 лет опыта работы со студентами и школьниками — преподавала 22 дисциплины в университете, вела педагогическую практику в школах; студенты под её руководством побеждали в республиканских научных конкурсах и в конкурсах СНГ",
    ],
    aboutPreview: "5 лет практической работы няней в семьях, более 20 лет опыта работы со студентами и школьниками",
    experience: [
      "5 лет практической работы няней в семьях — с детьми от 1,5 до 9 лет, в форматах проживания в семье, вахты и частичной занятости, включая VIP-семьи Москвы",
      "Сертифицированный преподаватель английского языка — владеет методикой преподавания на английском",
      "Более 20 лет опыта работы со студентами и школьниками — преподавала 22 дисциплины в университете, вела педагогическую практику в школах; студенты под её руководством побеждали в республиканских научных конкурсах и в конкурсах СНГ",
      "Опыт работы с детьми с задержкой развития, требующими индивидуального подхода",
      "Автор более 100 научных работ, включая 4 монографии",
      "Музыкальное образование (фортепиано) и художественная подготовка (масло, акварель, акрил)",
      "Дипломированный медиатор и юрист",
    ],
    subjects: [
  ...
  {
    image: expertFilippova,
    name: "Наталья Филиппова",
    role: "Нутрициолог",
    specialization: "Питание без стресса, культура еды",
    qualification: [
      "Нутрициолог, корпоративный нутрициолог",
      "Педагог-психолог",
      "Консультант по коррекции веса",
      "Специалист по пищевому поведению и РПП",
    ],
    qualificationPreview: "Нутрициолог, корпоративный нутрициолог, педагог-психолог",
    about: [
      "Специалист по пищевому поведению и РПП",
      "Организатор и ведущая мероприятий в сфере ЗОЖ",
      "Эксперт в СМИ",
    ],
    aboutPreview: "Специалист по пищевому поведению и РПП, организатор и ведущая мероприятий в сфере ЗОЖ",
    experience: [
      "Нутрициолог, корпоративный нутрициолог",
      "Педагог-психолог",
      "Консультант по коррекции веса",
      "Специалист по пищевому поведению и РПП",
      "Преподаватель в школе моделей",
      "Организатор и ведущая мероприятий в сфере ЗОЖ",
      "Эксперт в СМИ",
    ],
    subjects: [
      "Как формировать культуру еды",
      "Питание без стресса",
    ],
    links: [],
  },
